...
class AddBaseImageOption extends StatefulWidget {
  ...
  @override
  State<AddBaseImageOption> createState() => _AddBaseImageOptionState();
}

class _AddBaseImageOptionState extends State<AddBaseImageOption> {
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: TextButton(
                      onPressed: () {
                        Map<String, dynamic> imageProportionMap = {};
                        if (drawEngine == 1) {
                          base64Images.clear();
