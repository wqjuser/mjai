...
class MoonshotSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // Moonshot配置卡片
        _buildMoonshotConfigCard(settings),
      ],
    );
  }
  ...
  // Moonshot配置卡片
  Widget _buildMoonshotConfigCard(ChangeSettings settings) {
            ...
            children: [
              Expanded(
                child: _buildTextField(
                  controller: state.getTextController('moonshot_api_key'),
                  label: 'API Key',
