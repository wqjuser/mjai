...
class OSSSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        _buildSectionTitle('OSS存储设置', settings),
        const SizedBox(height: 16),

        // OSS配置卡片
        _buildOSSConfigCard(settings),
      ],
    );
  }
  ...
  // OSS配置卡片
  Widget _buildOSSConfigCard(ChangeSettings settings) {
            ...
            children: [
              Expanded(
                child: _buildTextField(
                  controller: state.getTextController('oss_bucket_name'),
                  label: 'Bucket名称',
              ...
              Expanded(
                child: _buildTextField(
                  controller: state.getTextController('oss_endpoint'),
                  label: 'Endpoint',
                  onChanged: (text) async {
              ...
              Expanded(
                child: _buildTextField(
                  controller: state.getTextController('oss_api_url'),
                  label: 'API地址',
                  onChanged: (text) async {
