const Map<String, dynamic> fooocusTranslate = {
  "Preview": "预览",
  "Gallery": "相册",
  "Generate": "生成",
  "Skip": "跳过",
  ...
  "PyraCanny": "边缘检测",
  "CPDS": "深度结构检测",
  "* \"Image Prompt\" is powered by Fooocus Image Mixture Engine (v1.0.1).": "* \"图像输入\"由 Fooocus 图像混合引擎提供支持（v1.0.1）。",
  ...
  "* \"Inpaint or Outpaint\" is powered by the sampler \"DPMPP Fooocus Seamless 2M SDE Karras Inpaint Sampler\" (beta)":
      "* \"内部填充或外部填充\"由 \"DPMPP Fooocus Seamless 2M SDE Karras Inpaint Sampler\"（测试版）采样器提供支持",
  "Setting": "设置",
  "Style": "样式",
  "Performance": "性能",
  "Speed": "速度",
  ...
  "sd_xl_refiner_1.0_0.9vae.safetensors": "精炼模型 sd_xl_refiner_1.0_0.9vae",
  "Refiner (SDXL or SD 1.5)": "精炼模型 （支持SDXL 或 SD 1.5）",
  "None": "无",
  "LoRAs": "LoRAs模型",
  ...
  "ADM Guidance End At Step": "ADM引导结束步数",
  ...
  "Enabling Fooocus's implementation of CFG mimicking for TSNR (effective when real CFG > mimicked CFG).":
      "启用TSNR模拟CFG，修复因CFG过高而引起的画面污染（当真实的CFG大于模拟的CFG时生效）。",
  "Sampler": "采样器",
  ...
  "Forced Overwrite of Sampling Step": "强制覆盖采样步数",
  ...
  "Set as -1 to disable. For developer debugging. Results will be worse for non-standard numbers that SDXL is not trained on.":
      "设为-1以禁用。用于开发者调试。对于SDXL没有训练过的非标准数字，结果会差。",
  ...
  "Mixing Image Prompt and Vary/Upscale": "混合图像提示词和变化/放大",
  "Mixing Image Prompt and Inpaint": "混合图像提示词和重绘",
  ...
  "S2": "S2",
  "Extreme Speed": "极速LCM",
  "\uD83D\uDD0E Type here to search styles ...": "\uD83D\uDD0E 在此输入关键词搜索样式……",
  "Type prompt here.": "在这里输入提示词，用英文逗号分隔。（支持选中后用Ctrl+上下方向键调整提示词权重，支持wildcards文件夹内通配符批量出图：__通配符文件名__提示词）",
  "Outpaint Expansion Direction:": "外部扩展方向：",
  "* Powered by Fooocus Inpaint Engine (beta)": "* 由Fooocus修复引擎驱动（测试版）",
  "Fooocus Enhance": "Fooocus-优化增强",
  "Fooocus Cinematic": "Fooocus-电影感",
  "Fooocus Sharp": "Fooocus-锐化",
  "bluePencilXL_v080.safetensors": "动漫模型 bluePencilXL_v080",
  ...
  "- Move canvas": "= 移动画布",
  "- Overlap": "= 图层重叠",
  "Refiner Switch At": "精炼器切换节点",
  "Use 0.4 for SD1.5 realistic models; or 0.667 for SD1.5 anime models; or 0.8 for XL-refiners; or any value for switching two SDXL models.":
      "SD1.5的现实模型用0.4；SD1.5的动漫模型用0.667；XL专用精炼模型用0.8；两个SDXL模型之间可以在任意节点切换。",
  "Initializing ...": "正在初始化……（等太久请使用固态盘，卡住请更新显卡驱动）",
  "Downloading inpainter ...": "正在下载局部重绘工具……",
  "Downloading upscale models ...": "正在下载放大模型……",
  ...
  "Encoding positive #1 ...": "编码正向提示词 #1……",
  "Encoding negative #1 ...": "编码反向提示词 #1……",
  "VAE encoding ...": "正在编码VAE……",
  "VAE Inpaint encoding ...": "正在编码局部重绘VAE……",
  "VAE Inpaint SD15 encoding ...": "正在编码SD1.5局部重绘VAE……",
  "Moving model to GPU ...": "正在将模型移动到GPU……",
  ...
  "(Experimental) This may cause performance problems on some computers and certain internet conditions.":
      "（试验性）在某些计算机和特定的网络条件下，这可能会导致性能问题。",
  "Use brush": "使用画笔",
  "Undo": "撤回一步",
  "Clear": "清除",
  "Remove Image": "关闭图片",
  "Edit": "编辑",
  "LoRAs (SDXL or SD 1.5)": "Lora微调模型 （支持SDXL 或 SD 1.5）",
  "ImagePrompt": "图像提示词",
  "FaceSwap": "换脸",
  "v2.6": "v2.6测试版",
  "See the results from preprocessors.": "查看预处理器结果。",
  "Skip Preprocessors": "跳过预处理器",
  "Do not preprocess images. (Inputs are already canny/depth/cropped-face/etc.)": "不要对图像进行预处理。（输入的图像已经是边缘检测/深度/换脸等。）"
};
